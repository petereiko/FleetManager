...
namespace FleetManager.App.Areas.Company.Controllers
{
    ...
    public class OnboardAdminController : Controller
    {
        ...
        private readonly ILogger<OnboardAdminController> _logger;

        public OnboardAdminController(
            ICompanyAdminService adminService,
            IBranchService branchService,
            ICompanyManagementService companyService,
            IAuthUser authUser,
            ILogger<OnboardAdminController> logger,
