        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoadWorthyExpiryDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NextOfKins_Drivers_DriverId",
                        column: x => x.DriverId,
            ...
            migrationBuilder.CreateTable(
                name: "DriverVehicleLocations",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DriverVehicleId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DriverVehicleLocations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DriverVehicleLocations_DriverVehicles_DriverVehicleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DriverVehicleLocations_DriverVehicleId",
