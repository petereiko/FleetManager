...
namespace FleetManager.Business.Migrations
{
    ...
    [Migration("20250701132611_InitVendorRental")]
    partial class InitVendorRental
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FleetManager.Business.Database.Entities.Vendor", b =>
                {
                    ...
                    b.Property<int?>("VendorServiceOfferedId")
                        .HasColumnType("int");

                    b.Property<int>("VendorServicesOfferedId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("VendorServiceOfferedId");
            ...
            modelBuilder.Entity("FleetManager.Business.Database.Entities.VendorServiceOffered", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("VendorServicesOffered");
                });
            ...
            modelBuilder.Entity("FleetManager.Business.Database.Entities.Vendor", b =>
                {
                    ...
                    b.HasOne("FleetManager.Business.Database.Entities.VendorServiceOffered", "VendorServiceOffered")
                        .WithMany()
                        .HasForeignKey("VendorServiceOfferedId");

                    b.Navigation("User");

                    b.Navigation("VendorCategory");

                    b.Navigation("VendorServiceOffered");
                });
