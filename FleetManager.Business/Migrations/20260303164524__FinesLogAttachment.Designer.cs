...
namespace FleetManager.Business.Migrations
{
    ...
    [Migration("20260303164524__FinesLogAttachment")]
    partial class _FinesLogAttachment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FleetManager.Business.Database.Entities.ContactRating", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("ContactDirectoryId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ContactDirectoryId");

                    b.HasIndex("UserId");

                    b.ToTable("ContactRatings");
                });

            modelBuilder.Entity("FleetManager.Business.Database.Entities.DailyTripAggregate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FleetManager.Business.Database.Entities.FineAndTollAttachment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("FineAndTollId");

                    b.ToTable("FineAndTollAttachments");
                });
            ...
            modelBuilder.Entity("FleetManager.Business.Database.Entities.RepairHistory.Repair", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FleetManager.Business.Database.Entities.RepairHistory.RepairInvoice", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("RepairInvoices");
                });

            modelBuilder.Entity("FleetManager.Business.Database.Entities.RepairHistory.RepairInvoiceItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("RepairInvoiceId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("RepairInvoiceItems");
                });

            modelBuilder.Entity("FleetManager.Business.Database.Entities.RepairHistory.RepairItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FleetManager.Business.Database.Entities.TripCheckpoint", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FleetManager.Business.Database.Entities.TripDocument", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FleetManager.Business.Database.Entities.TripExpense", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FleetManager.Business.Database.Entities.Vehicle", b =>
                {
                    ...
                    b.Property<string>("CustomMakeName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FleetManager.Business.Database.Entities.WebhookDeliveryLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FleetManager.Business.Database.Entities.ContactRating", b =>
                {
                    ...
                    b.HasOne("FleetManager.Business.Database.Entities.ContactDirectory", "ContactDirectory")
                        .WithMany("Ratings")
                        .HasForeignKey("ContactDirectoryId")
            ...
            modelBuilder.Entity("FleetManager.Business.Database.Entities.FineAndTollAttachment", b =>
                {
                    b.HasOne("FleetManager.Business.Database.Entities.FineAndToll", "FineAndToll")
                        .WithMany("Attachments")
                        .HasForeignKey("FineAndTollId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FineAndToll");
                });
            ...
            modelBuilder.Entity("FleetManager.Business.Database.Entities.RepairHistory.RepairInvoice", b =>
                {
                    ...
                    b.HasOne("FleetManager.Business.Database.Entities.RepairHistory.Repair", "Repair")
                        .WithOne("Invoice")
                        .HasForeignKey("FleetManager.Business.Database.Entities.RepairHistory.RepairInvoice", "RepairId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FleetManager.Business.Database.Entities.RepairHistory.RepairInvoiceItem", b =>
                {
                    b.HasOne("FleetManager.Business.Database.Entities.RepairHistory.RepairInvoice", "RepairInvoice")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("FleetManager.Business.Database.Entities.TripCheckpoint", b =>
                {
                    b.HasOne("FleetManager.Business.Database.Entities.Trip", "Trip")
